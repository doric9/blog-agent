...
**Steps:**
1. **Backand Act Questions** → [modes/initial-design-questions.md](resources/modes/initial-design-questions.md)
   - Act Purpose, Cast Identification, Cast Goal, Input/Output, Constraints
2. **Chat Cast Design** → Follow "Cast Design Workflow" below
3. **Generate CLAUDE.md files** → Use [act-template.md](resources/act-template.md) and [cast-template.md](resources/cast-template.md)
   ...
   - Create `/casts/chat/CLAUDE.md` (Cast details)
...
**Steps:**
1. **Read CLAUDE.md** → Understand existing Backand Act and Casts
